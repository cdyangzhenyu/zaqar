...
class CollectionResource(object):
    ...
    def on_get(self, req, resp, project_id, queue_name):
        ...
        try:
            ...
            for msg in resp_msgs:
                if auto_delete:
                    self._message_controller.consume_delete(queue_name, msg['handle'],
                                                            project=project_id)    
    ...
    def on_delete(self, req, resp, project_id, queue_name):
        ...
        if ids:
            resp.status, resp.body = self._delete_messages_by_consume_id(queue_name, ids,
                                                                         project_id)

    def _delete_messages_by_consume_id(self, queue_name, ids, project_id):
        try:
            res = self._message_controller.bulk_consume_delete(
                    queue_name,
                    consume_ids=ids,
                    project=project_id)
